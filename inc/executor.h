...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/06/04 21:00:47 by mavissar          #+#    #+#             */
/*   Updated: 2025/06/04 21:10:57 by mavissar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	child_process(t_command *cmd, int **pipes, int i,
			t_env *env);
// void wait_and_cleanup(int **pipes, pid_t *pids, int n, t_env *env);
// int setup_pipes_and_fork(t_command *cmds, t_env *env, int **pipes,
	//pid_t *pids);
...
void	wait_and_cleanup(int **pipes, pid_t *pids, int n,
			t_env *env);
void	cleanup_memory(int **pipes, pid_t *pids, int n);
int		create_all_pipes(int **pipes, int num_cmds);
int		fork_all_processes(t_command *cmds, int **pipes,
			pid_t *pids, t_env *env);
